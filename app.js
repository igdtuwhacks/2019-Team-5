...
app.get("/trainer-register", (req, res) => {
  res.render("pages/treg");
});

app.get("/learner-register", (req, res) => {
  res.render("pages/lreg");
});

app.get("/dashboard", (req, res) => {
  res.render("pages/trainerdash");
});

app.get("/bulletinboard", (req, res) => {
  res.render("pages/bulletinboard");
});
